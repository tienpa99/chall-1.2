    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST"  enctype="multipart/form-data" action="{{ route('assignments.store') }}" aria-label="{{ __('Add') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="content" id="" cols="43" rows="10" style="" required=""></textarea>
                            </div>
                        </div>
